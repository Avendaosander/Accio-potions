...
function ModalEditar({ handleAlert, handlePotions, handleModalEdit, ingredientes, pocion, setAlertaObj }) {
   ...
   const handleSubmit = async e => {
      ...
      handleAlert(true) 
      setAlertaObj({
         message: 'La pocion ha sido modificada',
         colorMui: 'success',
         variante: 'filled'
      })
      handleModalEdit()
   ...
   return (
      <section className='fixed bg-black/50 top-0 right-0 left-0 bottom-0 flex justify-center items-center'>
         <article className='bg-purple-400 rounded-2xl px-10 py-5 max-w-[65rem] max-4'>
